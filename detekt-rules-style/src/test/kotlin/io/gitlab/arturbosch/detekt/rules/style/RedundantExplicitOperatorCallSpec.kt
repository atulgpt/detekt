...
class RedundantExplicitOperatorCallSpec(val env: KotlinCoreEnvironment) {
    val subject = RedundantExplicitOperatorCall(Config.empty)

    @Nested
    @KotlinCoreEnvironmentTest
    inner class WithDefaultSources {
        @Nested
