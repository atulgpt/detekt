...
internal class StringExtensionsKtSpec {
    ...
    companion object {
        @JvmStatic
        fun getAllowedMarkDownUrlPattern(): List<Arguments> = listOf(
        ...
        @JvmStatic
        fun getDisAllowedMarkDownUrlPattern(): List<Arguments> = listOf(
            Arguments.of("""[]()"""),
            Arguments.of("""[](foo)"""),
            Arguments.of("""[bar]()"""),
            Arguments.of("""[Label](www.foo.com"""),
        ...
        @JvmStatic
        fun getAllowedKotlinReferenceUrlPattern(): List<Arguments> = listOf(
        ...
        @JvmStatic
        fun getDisAllowedKotlinReferenceUrlPattern(): List<Arguments> = listOf(
